...
| 5 | Staffordshire |
| 4 | Bristol & Bath |
| 4 | Greater Manchester - Manchester & Salford |
| 4 | Essex |
| 4 | Yorkshire - West |
| 3 | London |
| 3 | Hertfordshire |
| 2 | Scotland West - Glasgow |
| 2 | North East - Tyneside, Wearside & Northumberland |
| 1 | Dorset |
...
| 1 | South West |
| 1 | West Midlands |
| 1 | Scotland West - Renfrewshire & Inverclyde |
| 1 | Kent |
| 1 | Cheshire - West |
| 1 | Leicestershire |
...
| 2 | Technical Claims Handler |
| 1 | Claims Handler - Home / Motor / Insurance - Remote |
| 1 | Junior Claims Technician - Marine |
| 1 | Claims Administrator |
| 1 | Credit Hire Claims Handler |
| 1 | Claims & Customer Service Advisor |
| 1 | Senior Claims Handler EL/PL |
| 1 | EL/PL Liability Claims Handler |
| 1 | FNOL Motor Claims Handler |
| 1 | Personal Injury Claims Handler |
| 1 | Commercial Claims Handler (Personal Lines Handlers Considered!) |
| 1 | Claims Handler (Top Insurance Company) |
| 1 | Legal Claim Handler |
| 1 | Legal Claims Advisor |
| 1 | Claims Administrator - Life and Pensions |
| 1 | Disease Claims Handler (3 - Month FTC) |

## Salary guard check

Content-unique IN jobs with usable annualised maximum: **8**.
