...
Jobs in feed: **10,000**
Broad insurance/claims universe: **99** raw rows
IN after advert-level boundary rules: **12** raw rows
BORDERLINE: **0** raw rows
OUT: **87** raw rows
Content-unique IN jobs: **12** (removed **0** exact-content duplicate rows)
