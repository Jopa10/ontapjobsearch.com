# JobG8 Marketing regional recurrence — current feed

Canonical UK assessment universe: **78 markets**.
Counts use content-unique adverts after source-reference dedupe.
LIKELY_IN jobs mapped into the universe: **90**.
BORDERLINE jobs mapped into the universe: **43**.
Markets with at least one LIKELY_IN job: **35 / 78**.

Descriptive current-feed spread only — these thresholds do not activate a slice:
- markets with 3+ LIKELY_IN: **12**
- markets with 6+ LIKELY_IN: **3**
...
| London | 17 | 15 | 32 |
| Surrey | 6 | 2 | 8 |
| Greater Manchester - Manchester & Salford | 6 | 1 | 7 |
| West Midlands - Birmingham & Solihull | 4 | 4 | 8 |
| Yorkshire - West | 4 | 2 | 6 |
| Berkshire | 4 | 0 | 4 |
| Kent | 3 | 2 | 5 |
| Norfolk | 3 | 1 | 4 |
| Nottinghamshire | 3 | 1 | 4 |
| Yorkshire - South | 3 | 1 | 4 |
| Lincolnshire | 3 | 0 | 3 |
| Merseyside - Liverpool | 3 | 0 | 3 |
| Yorkshire - North | 2 | 3 | 5 |
| Northamptonshire | 2 | 1 | 3 |
| Sussex | 2 | 1 | 3 |
| Bristol & Bath | 2 | 0 | 2 |
| Dorset | 2 | 0 | 2 |
| Scotland West - Glasgow | 2 | 0 | 2 |
| Staffordshire | 2 | 0 | 2 |
