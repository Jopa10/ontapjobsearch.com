# JobG8 Warehouse & Logistics Operations regional recurrence — current feed

Canonical UK assessment universe: **78 markets**.
Counts use content-unique adverts after source-reference dedupe.
LIKELY_IN jobs mapped into the universe: **13**.
BORDERLINE jobs mapped into the universe: **10**.
Markets with at least one LIKELY_IN job: **12 / 78**.

Descriptive current-feed spread only — these thresholds do not activate a slice:
- markets with 3+ LIKELY_IN: **0**
...
| West Midlands - Black Country | 1 | 1 | 2 |
| Berkshire | 1 | 0 | 1 |
...
| Greater Manchester - Manchester & Salford | 0 | 0 | 0 |
