...
class DailyFamilyCoverageSalesTests(unittest.TestCase):
    def test_apply_existing_populates_nonlive_rolling_metrics_only(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertIn("| Cumbria - North | 3 / 2.0 / 0/2 | 6 / 5.0 / 1/2 | 2 / 2.5 / 0/2 | 4 / 3.0 / 0/2 | 3 / 2.0 / 0/2 |", text)
            self.assertIn("| Yorkshire - North | 4 / 5.0 / 1/2 | 5 / 6.0 / 1/2 | 8 / 7.0 / 2/2 | 7 / 6.0 / 1/2 | 6 / 5.0 / 1/2 |", text)
