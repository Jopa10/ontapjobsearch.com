...
- 24 August 2026 — **Housing Officer new-family discovery started, diagnostic only:** `pipeline/config/family_discovery/housing_officer.json` defines a broad title-plus-description audit net and a narrower occupational boundary for council, housing-association, charity and supported-accommodation roles whose core work is tenancy, neighbourhood, housing-need or resident housing management. Supported/sheltered housing, generic income/complaints/liaison/ASB, property-management and manager titles require advert review; care/support work, estate agency, housing law, development/planning, asset/repairs/trades, benefits, technical work and senior leadership are outside. The reusable discovery workflow applies the >£50k ceiling, content dedupe and 78-market geography evidence. This creates diagnostic evidence only: Housing Officer has no catalogue/register/public route and cannot become LIVE without explicit owner approval.
