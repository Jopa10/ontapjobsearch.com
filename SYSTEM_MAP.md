...
- 19 August 2026 — Added same-feed 55-market family coverage for Service Admin and Support Worker inside the main JobG8 daily run.
...
6. **55-market diagnostic assessment** — once the selector is credible, assess every canonical region using the same family logic. This produces evidence only and must not activate slices automatically.
