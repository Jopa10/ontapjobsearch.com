...
- 24 August 2026 — **Marketing passed current-feed national boundary validation, but remains non-LIVE:** the refined 10k discovery produced 197 content-unique broad candidates; 61 were excluded for salary/specialist reasons, and advert-level review resolved the remaining evidence to **135 definite Marketing jobs nationally**. Of those, **119 map into 38 canonical UK markets**; final strongest-market counts are **London 27, Surrey 8, Greater Manchester - Manchester & Salford 7, West Midlands - Birmingham & Solihull 7, Kent 5 and Yorkshire - West 5**. `pipeline/reports-discovery-audit/jobg8-marketing-boundary-review-2026-08-24.md` records the frozen boundary and contextual decisions. This passes national viability only; no Marketing catalogue/register/public route exists and no market is LIVE without explicit owner approval after proof-region page-quality review.
