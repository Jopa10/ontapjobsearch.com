...
const route = "/portsmouth/service-administrator-jobs";
...
export const metadata: Metadata = {
  title: "Admin and office jobs in Portsmouth | Ontap Job Search",
  description: "Browse current admin and office jobs across Portsmouth and its approved local employment market.",
...
export default function Page() {
  ...
  return (
    <JobSlicePage
      ...
      region="Portsmouth"
      title="Admin and office jobs in Portsmouth"
      latestUpdate={latestUpdate}
      introText={`Current admin and office jobs across Portsmouth and its approved local employment market. Jobs are checked and updated daily. Latest update: ${latestUpdate} • Apply on employer sites`}
      anchorTown="Portsmouth"
