...
const route = "/northampton/service-administrator-jobs";
...
export const metadata: Metadata = {
  title: "Admin and office jobs in Northampton | Ontap Job Search",
  description: "Browse current admin and office jobs across Northampton and its approved local employment market.",
...
export default function Page() {
  ...
  return (
    <JobSlicePage
      ...
      region="Northampton"
      title="Admin and office jobs in Northampton"
      latestUpdate={latestUpdate}
      introText={`Current admin and office jobs across Northampton and its approved local employment market. Jobs are checked and updated daily. Latest update: ${latestUpdate} • Apply on employer sites`}
      anchorTown="Northampton"
      ...
      relatedPage={{
        href: "/job-search/northamptonshire/service-administrator-jobs",
