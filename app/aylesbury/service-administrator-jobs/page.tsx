...
const route = "/aylesbury/service-administrator-jobs";
...
export const metadata: Metadata = {
  title: "Admin and office jobs in Aylesbury | Ontap Job Search",
  description: "Browse current admin and office jobs across Aylesbury and its approved local employment market.",
...
export default function Page() {
  ...
  return (
    <JobSlicePage
      ...
      region="Aylesbury"
      title="Admin and office jobs in Aylesbury"
      latestUpdate={latestUpdate}
      introText={`Current admin and office jobs across Aylesbury and its approved local employment market. Jobs are checked and updated daily. Latest update: ${latestUpdate} • Apply on employer sites`}
      anchorTown="Aylesbury"
