...
export const metadata: Metadata = {
  title: "Admin and office jobs in Oxford | Ontap Job Search",
  description: "Browse current admin and office jobs across Oxford and its approved local employment market.",
...
export default function Page() {
  ...
  return <JobSlicePage jsonPath={[...definition.jsonPath]} region="Oxford" title="Admin and office jobs in Oxford" latestUpdate={latestUpdate} introText={`Current admin and office jobs across Oxford and its approved local employment market. Jobs are checked and updated daily. Latest update: ${latestUpdate} • Apply on employer sites`} anchorTown="Oxford" relatedPage={{href:"/job-search/oxfordshire/service-administrator-jobs",prompt:"Looking across the wider region?",label:"View all regional jobs"}} />;
}
