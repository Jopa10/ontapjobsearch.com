...
export const metadata: Metadata = {
  title: "Admin and office jobs in Manchester | Ontap Job Search",
  description: "Browse current admin and office jobs across Manchester and its approved local employment market.",
