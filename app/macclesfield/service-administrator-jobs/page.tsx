...
const route = "/macclesfield/service-administrator-jobs";
...
export const metadata: Metadata = {
  title: "Admin and office jobs in Macclesfield | Ontap Job Search",
  description: "Browse current admin and office jobs across Macclesfield and its approved local employment market.",
...
export default function Page() {
  ...
  return (
    <JobSlicePage
      ...
      region="Macclesfield"
      title="Admin and office jobs in Macclesfield"
      latestUpdate={latestUpdate}
      introText={`Current admin and office jobs across Macclesfield and its approved local employment market. Jobs are checked and updated daily. Latest update: ${latestUpdate} • Apply on employer sites`}
      anchorTown="Macclesfield"
      ...
      relatedPage={{
        href: "/job-search/cheshire-east/service-administrator-jobs",
