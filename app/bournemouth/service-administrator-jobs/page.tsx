...
const route = "/bournemouth/service-administrator-jobs";
...
export const metadata: Metadata = {
  title: "Admin and office jobs in Bournemouth | Ontap Job Search",
  description: "Browse current admin and office jobs across Bournemouth and its approved local employment market.",
...
export default function Page() {
  ...
  return (
    <JobSlicePage
      ...
      region="Bournemouth"
      title="Admin and office jobs in Bournemouth"
      latestUpdate={latestUpdate}
      introText={`Current admin and office jobs across Bournemouth and its approved local employment market. Jobs are checked and updated daily. Latest update: ${latestUpdate} • Apply on employer sites`}
      anchorTown="Bournemouth"
      ...
      relatedPage={{
        href: "/job-search/dorset/service-administrator-jobs",
