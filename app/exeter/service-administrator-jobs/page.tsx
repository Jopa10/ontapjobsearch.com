...
const route = "/exeter/service-administrator-jobs";
...
export const metadata: Metadata = {
  title: "Admin and office jobs in Exeter | Ontap Job Search",
  description: "Browse current admin and office jobs across Exeter and its approved local employment market.",
...
export default function Page() {
  ...
  return (
    <JobSlicePage
      ...
      region="Exeter"
      title="Admin and office jobs in Exeter"
      latestUpdate={latestUpdate}
      introText={`Current admin and office jobs across Exeter and its approved local employment market. Jobs are checked and updated daily. Latest update: ${latestUpdate} • Apply on employer sites`}
      anchorTown="Exeter"
