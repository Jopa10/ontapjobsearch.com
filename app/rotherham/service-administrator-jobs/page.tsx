...
const route = "/rotherham/service-administrator-jobs";
...
export const metadata: Metadata = {
  title: "Admin and office jobs in Rotherham | Ontap Job Search",
  description: "Browse current admin and office jobs across Rotherham and its approved local employment market.",
...
export default function Page() {
  ...
  return (
    <JobSlicePage
      ...
      region="Rotherham"
      title="Admin and office jobs in Rotherham"
      latestUpdate={latestUpdate}
      introText={`Current admin and office jobs across Rotherham and its approved local employment market. Jobs are checked and updated daily. Latest update: ${latestUpdate} • Apply on employer sites`}
      anchorTown="Rotherham"
