...
function readJobsJson(): JobRow[] {
  ...
  return parsed.map((r: any) => ({
    ...
    region: r.region || "South Yorkshire",
    country: "UK",
    category: r.category || "",
  ...
  return (
    <main style={{ maxWidth: 980, margin: "40px auto", padding: "0 16px" }}>
      <h1 style={{ fontSize: 28, fontWeight: 700 }}>
        South Yorkshire Support Worker Roles
      </h1>

      <p style={{ color: "#555", marginBottom: 20 }}>
        Updated daily • Latest update: Mon 27th April, AM • Roles across South Yorkshire • Apply on employer sites
      </p>
