...
const route = "/leicester/service-administrator-jobs";
...
export const metadata: Metadata = {
  title: "Admin and office jobs in Leicester | Ontap Job Search",
  description: "Browse current admin and office jobs across Leicester and its approved local employment market.",
...
export default function Page() {
  ...
  return (
    <JobSlicePage
      ...
      region="Leicester"
      title="Admin and office jobs in Leicester"
      latestUpdate={latestUpdate}
      introText={`Current admin and office jobs across Leicester and its approved local employment market. Jobs are checked and updated daily. Latest update: ${latestUpdate} • Apply on employer sites`}
      anchorTown="Leicester"
      ...
      relatedPage={{
        href: "/job-search/leicestershire/service-administrator-jobs",
