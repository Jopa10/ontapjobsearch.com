...
const route = "/gloucester/service-administrator-jobs";
...
export const metadata: Metadata = {
  title: "Admin and office jobs in Gloucester | Ontap Job Search",
  description: "Browse current admin and office jobs across Gloucester and its approved local employment market.",
...
export default function Page() {
  ...
  return (
    <JobSlicePage
      ...
      region="Gloucester"
      title="Admin and office jobs in Gloucester"
      latestUpdate={latestUpdate}
      introText={`Current admin and office jobs across Gloucester and its approved local employment market. Jobs are checked and updated daily. Latest update: ${latestUpdate} • Apply on employer sites`}
      anchorTown="Gloucester"
      ...
      relatedPage={{
        href: "/job-search/gloucestershire/service-administrator-jobs",
