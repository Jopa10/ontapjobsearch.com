...
const route = "/milton-keynes/service-administrator-jobs";
...
export const metadata: Metadata = {
  title: "Admin and office jobs in Milton Keynes | Ontap Job Search",
  description: "Browse current admin and office jobs across Milton Keynes and its approved local employment market.",
...
export default function Page() {
  ...
  return (
    <JobSlicePage
      ...
      title="Admin and office jobs in Milton Keynes"
      latestUpdate={latestUpdate}
      introText={`Current admin and office jobs across Milton Keynes and its approved local employment market. Jobs are checked and updated daily. Latest update: ${latestUpdate} • Apply on employer sites`}
      anchorTown="Milton Keynes"
      ...
      relatedPage={{
        href: "/job-search/buckinghamshire/service-administrator-jobs",
