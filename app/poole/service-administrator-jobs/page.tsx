...
const route = "/poole/service-administrator-jobs";
...
export const metadata: Metadata = {
  title: "Admin and office jobs in Poole | Ontap Job Search",
  description: "Browse current admin and office jobs across Poole and its approved local employment market.",
...
export default function Page() {
  ...
  return (
    <JobSlicePage
      ...
      region="Poole"
      title="Admin and office jobs in Poole"
      latestUpdate={latestUpdate}
      introText={`Current admin and office jobs across Poole and its approved local employment market. Jobs are checked and updated daily. Latest update: ${latestUpdate} • Apply on employer sites`}
      anchorTown="Poole"
