...
const route = "/plymouth/service-administrator-jobs";
...
export const metadata: Metadata = {
  title: "Admin and office jobs in Plymouth | Ontap Job Search",
  description: "Browse current admin and office jobs across Plymouth and its approved local employment market.",
...
export default function Page() {
  ...
  return (
    <JobSlicePage
      ...
      region="Plymouth"
      title="Admin and office jobs in Plymouth"
      latestUpdate={latestUpdate}
      introText={`Current admin and office jobs across Plymouth and its approved local employment market. Jobs are checked and updated daily. Latest update: ${latestUpdate} • Apply on employer sites`}
      anchorTown="Plymouth"
      ...
      relatedPage={{
        href: "/job-search/devon/service-administrator-jobs",
