...
const route = "/newtownabbey/service-administrator-jobs";
...
export const metadata: Metadata = {
  title: "Admin and office jobs in Newtownabbey | Ontap Job Search",
  description: "Browse current admin and office jobs across Newtownabbey and its approved local employment market.",
...
export default function Page() {
  ...
  return (
    <JobSlicePage
      ...
      region="Newtownabbey"
      title="Admin and office jobs in Newtownabbey"
      latestUpdate={latestUpdate}
      introText={`Current admin and office jobs across Newtownabbey and its approved local employment market. Jobs are checked and updated daily. Latest update: ${latestUpdate} • Apply on employer sites`}
      anchorTown="Newtownabbey"
      ...
      relatedPage={{
        href: "/job-search/northern-ireland-east/service-administrator-jobs",
