...
const route = "/stoke-on-trent/service-administrator-jobs";
...
export const metadata: Metadata = {
  title: "Admin and office jobs in Stoke-on-trent | Ontap Job Search",
  description: "Browse current admin and office jobs across Stoke-on-trent and its approved local employment market.",
...
export default function Page() {
  ...
  return (
    <JobSlicePage
      ...
      title="Admin and office jobs in Stoke-on-trent"
      latestUpdate={latestUpdate}
      introText={`Current admin and office jobs across Stoke-on-trent and its approved local employment market. Jobs are checked and updated daily. Latest update: ${latestUpdate} • Apply on employer sites`}
      anchorTown="Stoke-on-trent"
      ...
      relatedPage={{
        href: "/job-search/staffordshire/service-administrator-jobs",
