...
const route = "/maidstone/service-administrator-jobs";
...
export const metadata: Metadata = {
  title: "Admin and office jobs in Maidstone | Ontap Job Search",
  description: "Browse current admin and office jobs across Maidstone and its approved local employment market.",
...
export default function Page() {
  ...
  return (
    <JobSlicePage
      ...
      region="Maidstone"
      title="Admin and office jobs in Maidstone"
      latestUpdate={latestUpdate}
      introText={`Current admin and office jobs across Maidstone and its approved local employment market. Jobs are checked and updated daily. Latest update: ${latestUpdate} • Apply on employer sites`}
      anchorTown="Maidstone"
