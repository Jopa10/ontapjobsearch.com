...
const route = "/chester-le-street/service-administrator-jobs";
...
export const metadata: Metadata = {
  title: "Admin and office jobs in Chester Le Street | Ontap Job Search",
  description: "Browse current admin and office jobs across Chester Le Street and its approved local employment market.",
...
export default function Page() {
  ...
  return (
    <JobSlicePage
      ...
      region="Chester Le Street"
      title="Admin and office jobs in Chester Le Street"
      latestUpdate={latestUpdate}
      introText={`Current admin and office jobs across Chester Le Street and its approved local employment market. Jobs are checked and updated daily. Latest update: ${latestUpdate} • Apply on employer sites`}
      anchorTown="Chester Le Street"
