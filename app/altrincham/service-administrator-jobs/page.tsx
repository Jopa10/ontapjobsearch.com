...
const route = "/altrincham/service-administrator-jobs";
...
export const metadata: Metadata = {
  title: "Admin and office jobs in Altrincham | Ontap Job Search",
  description: "Browse current admin and office jobs across Altrincham and its approved local employment market.",
...
export default function Page() {
  ...
  return (
    <JobSlicePage
      ...
      region="Altrincham"
      title="Admin and office jobs in Altrincham"
      latestUpdate={latestUpdate}
      introText={`Current admin and office jobs across Altrincham and its approved local employment market. Jobs are checked and updated daily. Latest update: ${latestUpdate} • Apply on employer sites`}
      anchorTown="Altrincham"
      ...
      relatedPage={{
        href: "/job-search/greater-manchester-south/service-administrator-jobs",
