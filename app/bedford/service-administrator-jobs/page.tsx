...
const route = "/bedford/service-administrator-jobs";
...
export const metadata: Metadata = {
  title: "Admin and office jobs in Bedford | Ontap Job Search",
  description: "Browse current admin and office jobs across Bedford and its approved local employment market.",
...
export default function Page() {
  ...
  return (
    <JobSlicePage
      ...
      region="Bedford"
      title="Admin and office jobs in Bedford"
      latestUpdate={latestUpdate}
      introText={`Current admin and office jobs across Bedford and its approved local employment market. Jobs are checked and updated daily. Latest update: ${latestUpdate} • Apply on employer sites`}
      anchorTown="Bedford"
      ...
      relatedPage={{
        href: "/job-search/bedfordshire/service-administrator-jobs",
