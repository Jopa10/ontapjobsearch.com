...
export const metadata: Metadata = {
  title: "Admin and office jobs in Coventry | Ontap Job Search",
  description: "Browse current admin and office jobs across Coventry and its approved local employment market.",
...
export default function Page() {
  ...
  return (
    <JobSlicePage
      ...
      region="Coventry"
      title="Admin and office jobs in Coventry"
      latestUpdate={latestUpdate}
      introText={`Current admin and office jobs across Coventry and its approved local employment market. Jobs are checked and updated daily. Latest update: ${latestUpdate} • Apply on employer sites`}
      anchorTown="Coventry"
