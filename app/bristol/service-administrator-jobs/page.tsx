...
export const metadata: Metadata = {
  title: "Bristol Admin & Customer Service Jobs | Ontap Job Search",
  description: "Browse current admin and customer-service jobs across Bristol and its approved local employment market.",
...
export default function Page() {
  ...
  return <JobSlicePage jsonPath={[...definition.jsonPath]} region="Bristol" title="Bristol Admin & Customer Service Jobs" latestUpdate={latestUpdate} introText={`Current admin and customer-service jobs across Bristol and its approved local employment market. Jobs are checked and updated daily. Latest update: ${latestUpdate} • Apply on employer sites`} anchorTown="Bristol" relatedPage={{href:"/job-search/bristol-bath/service-administrator-jobs",prompt:"Looking across the wider region?",label:"View all regional jobs"}} />;
}
