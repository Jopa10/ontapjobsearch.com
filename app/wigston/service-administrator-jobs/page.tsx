...
const route = "/wigston/service-administrator-jobs";
...
export const metadata: Metadata = {
  title: "Admin and office jobs in Wigston | Ontap Job Search",
  description: "Browse current admin and office jobs across Wigston and its approved local employment market.",
...
export default function Page() {
  ...
  return (
    <JobSlicePage
      ...
      region="Wigston"
      title="Admin and office jobs in Wigston"
      latestUpdate={latestUpdate}
      introText={`Current admin and office jobs across Wigston and its approved local employment market. Jobs are checked and updated daily. Latest update: ${latestUpdate} • Apply on employer sites`}
      anchorTown="Wigston"
