...
const route = "/shrewsbury/service-administrator-jobs";
...
export const metadata: Metadata = {
  title: "Admin and office jobs in Shrewsbury | Ontap Job Search",
  description: "Browse current admin and office jobs across Shrewsbury and its approved local employment market.",
...
export default function Page() {
  ...
  return (
    <JobSlicePage
      ...
      region="Shrewsbury"
      title="Admin and office jobs in Shrewsbury"
      latestUpdate={latestUpdate}
      introText={`Current admin and office jobs across Shrewsbury and its approved local employment market. Jobs are checked and updated daily. Latest update: ${latestUpdate} • Apply on employer sites`}
      anchorTown="Shrewsbury"
      ...
      relatedPage={{
        href: "/job-search/shropshire/service-administrator-jobs",
