...
const route = "/scarborough/service-administrator-jobs";
...
export const metadata: Metadata = {
  title: "Admin and office jobs in Scarborough | Ontap Job Search",
  description: "Browse current admin and office jobs across Scarborough and its approved local employment market.",
...
export default function Page() {
  ...
  return (
    <JobSlicePage
      ...
      region="Scarborough"
      title="Admin and office jobs in Scarborough"
      latestUpdate={latestUpdate}
      introText={`Current admin and office jobs across Scarborough and its approved local employment market. Jobs are checked and updated daily. Latest update: ${latestUpdate} • Apply on employer sites`}
      anchorTown="Scarborough"
