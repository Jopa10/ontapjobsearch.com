...
const routeKey = "surrey/service-administrator-jobs";
const canonicalUrl = "https://www.ontapjobsearch.com/surrey/service-administrator-jobs";

export const metadata: Metadata = {
  title: "Surrey Service Administrator Jobs | Ontap Job Search",
  description:
    "Browse service administrator, customer service administrator and office support jobs across Surrey.",
  alternates: {
...
export default function Page() {
  return (
    <JobSlicePage
      jsonPath={["app", "surrey", "service-administrator-jobs.json"]}
      region="Surrey"
      title="Surrey Service Administrator Jobs"
      latestUpdate={getJobPageStatus(routeKey)}
      anchorTown="Guildford"
