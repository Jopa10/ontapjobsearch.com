export const metadata = {
  title: "Ontap — Fin Officer jobs in Leeds",
  description: "Public sector and charity Fin Officer roles in Leeds.",
};
...
export default function Page() {
  return (
    <main className="max-w-2xl mx-auto p-6">
      <h1 className="text-2xl font-bold mb-6">FO jobs in Leeds</h1>
