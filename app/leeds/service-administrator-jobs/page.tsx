...
export const metadata: Metadata = {
  title: "Admin and office jobs in Leeds | Ontap Job Search",
  description: "Browse current admin and office jobs across Leeds and its approved local employment market.",
...
export default function Page() {
  ...
  return (
    <JobSlicePage
      ...
      region="Leeds"
      title="Admin and office jobs in Leeds"
      latestUpdate={latestUpdate}
      introText={`Current admin and office jobs across Leeds and its approved local employment market. Jobs are checked and updated daily. Latest update: ${latestUpdate} • Apply on employer sites`}
      anchorTown="Leeds"
