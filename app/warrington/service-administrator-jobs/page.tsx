...
export const metadata: Metadata = {
  title: "Warrington Admin & Customer Service Jobs | Ontap Job Search",
  description: "Browse current admin and customer-service jobs across Warrington and its approved local employment market.",
...
export default function Page() {
  ...
  return <JobSlicePage jsonPath={[...definition.jsonPath]} region="Warrington" title="Warrington Admin & Customer Service Jobs" latestUpdate={latestUpdate} introText={`Current admin and customer-service jobs across Warrington and its approved local employment market. Jobs are checked and updated daily. Latest update: ${latestUpdate} • Apply on employer sites`} anchorTown="Warrington" relatedPage={{href:"/job-search/warrington-halton/service-administrator-jobs",prompt:"Looking across the wider region?",label:"View all regional jobs"}} />;
}
