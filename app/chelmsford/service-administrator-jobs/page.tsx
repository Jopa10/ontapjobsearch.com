...
const route = "/chelmsford/service-administrator-jobs";
...
export const metadata: Metadata = {
  title: "Admin and office jobs in Chelmsford | Ontap Job Search",
  description: "Browse current admin and office jobs across Chelmsford and its approved local employment market.",
...
export default function Page() {
  ...
  return (
    <JobSlicePage
      ...
      region="Chelmsford"
      title="Admin and office jobs in Chelmsford"
      latestUpdate={latestUpdate}
      introText={`Current admin and office jobs across Chelmsford and its approved local employment market. Jobs are checked and updated daily. Latest update: ${latestUpdate} • Apply on employer sites`}
      anchorTown="Chelmsford"
      ...
      relatedPage={{
        href: "/job-search/essex/service-administrator-jobs",
