...
const route = "/sunderland/service-administrator-jobs";
...
export const metadata: Metadata = {
  title: "Admin and office jobs in Sunderland | Ontap Job Search",
  description: "Browse current admin and office jobs across Sunderland and its approved local employment market.",
...
export default function Page() {
  ...
  return (
    <JobSlicePage
      ...
      region="Sunderland"
      title="Admin and office jobs in Sunderland"
      latestUpdate={latestUpdate}
      introText={`Current admin and office jobs across Sunderland and its approved local employment market. Jobs are checked and updated daily. Latest update: ${latestUpdate} • Apply on employer sites`}
      anchorTown="Sunderland"
