...
const routeKey = "kent/service-administrator-jobs";
const canonicalUrl = "https://www.ontapjobsearch.com/kent/service-administrator-jobs";

export const metadata: Metadata = {
  title: "Kent Service Administrator Jobs | Ontap Job Search",
  description:
    "Browse service administrator, customer service administrator and office support jobs across Kent.",
  alternates: {
...
export default function Page() {
  return (
    <JobSlicePage
      jsonPath={["app", "kent", "service-administrator-jobs.json"]}
      region="Kent"
      title="Kent Service Administrator Jobs"
