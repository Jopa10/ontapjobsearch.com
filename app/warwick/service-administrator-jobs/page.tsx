...
const route = "/warwick/service-administrator-jobs";
...
export const metadata: Metadata = {
  title: "Admin and office jobs in Warwick | Ontap Job Search",
  description: "Browse current admin and office jobs across Warwick and its approved local employment market.",
...
export default function Page() {
  ...
  return (
    <JobSlicePage
      ...
      region="Warwick"
      title="Admin and office jobs in Warwick"
      latestUpdate={latestUpdate}
      introText={`Current admin and office jobs across Warwick and its approved local employment market. Jobs are checked and updated daily. Latest update: ${latestUpdate} • Apply on employer sites`}
      anchorTown="Warwick"
