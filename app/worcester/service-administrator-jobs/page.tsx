...
const route = "/worcester/service-administrator-jobs";
...
export const metadata: Metadata = {
  title: "Admin and office jobs in Worcester | Ontap Job Search",
  description: "Browse current admin and office jobs across Worcester and its approved local employment market.",
...
export default function Page() {
  ...
  return (
    <JobSlicePage
      ...
      region="Worcester"
      title="Admin and office jobs in Worcester"
      latestUpdate={latestUpdate}
      introText={`Current admin and office jobs across Worcester and its approved local employment market. Jobs are checked and updated daily. Latest update: ${latestUpdate} • Apply on employer sites`}
      anchorTown="Worcester"
      ...
      relatedPage={{
        href: "/job-search/worcestershire/service-administrator-jobs",
