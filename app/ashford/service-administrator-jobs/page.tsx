...
const route = "/ashford/service-administrator-jobs";
...
export const metadata: Metadata = {
  title: "Admin and office jobs in Ashford | Ontap Job Search",
  description: "Browse current admin and office jobs across Ashford and its approved local employment market.",
...
export default function Page() {
  ...
  return (
    <JobSlicePage
      ...
      region="Ashford"
      title="Admin and office jobs in Ashford"
      latestUpdate={latestUpdate}
      introText={`Current admin and office jobs across Ashford and its approved local employment market. Jobs are checked and updated daily. Latest update: ${latestUpdate} • Apply on employer sites`}
      anchorTown="Ashford"
