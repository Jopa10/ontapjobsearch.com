...
- 23 September 2026, corrected 25 September — **ACCA/ACA/CIMA qualification checks are title-scoped:** they apply to Assistant Accountant and Assistant Management Accountant roles; ordinary Bookkeeper, payroll, credit-control and legal-office roles do not go to qualification review. For in-scope titles, explicit mandatory ACCA/ACA/CIMA excludes, AAT is allowed, and missing/preferred/unclear qualification wording goes to review. Daily review rows show whether salary came from JobG8 fields, was extracted from the description, or no supported amount was found. Individual selector errors remain isolated from the rest of the daily publishing process.
