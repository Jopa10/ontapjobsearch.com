...
**Status:** Canonical production state after architecture cleanup, regional/city expansion, deployment-path verification, NHS Administrative & Clerical integration, search/UX hardening, Customer Sales production launch, three-family regional diagnostics and Teaching Vacancies refresh-resilience verification.
...
- the twice-daily full JobG8 process, which refreshes and composes NHS transactionally, generates every approved Customer Sales slice, and persists 33-region same-feed diagnostic coverage for Service Admin, Support Worker and Customer Sales;
